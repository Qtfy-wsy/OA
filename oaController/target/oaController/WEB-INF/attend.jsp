			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<c:forEach var="duty" items="${dutyList}">
					<tr class="text-c va-m">
						<td><input name="id" type="radio" value="${duty.dutyType}"></td>
						<td>${duty.dutyType}</td>
						<td class="text-l">${duty.dutyName}</td>
						<td class="text-l">${duty.general}</td>
						<td class="text-l">${duty.dutyTime1}</td>
						<td class="text-l">${duty.dutyTime2}</td>
						<td class="text-l">${duty.dutyTime3}</td>
						<td class="text-l">${duty.dutyTime4}</td>
						<td class="text-l">${duty.dutyTime5}</td>
						<td class="text-l">${duty.dutyTime6}</td>
					</tr>
				</c:forEach>
				</tbody>
			</table>
